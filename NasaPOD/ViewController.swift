...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print(jsonData)
        let urls = URL(string: "https://api.nasa.gov/planetary/apod?api_key=nu4eDuHQaqW7hg6ZIAsLJU1XLFZgQbOqyw2tdtXz")!
        let jsndatd = try! Data(contentsOf: URL(string: "https://api.nasa.gov/planetary/apod?api_key=nu4eDuHQaqW7hg6ZIAsLJU1XLFZgQbOqyw2tdtXz")!)
